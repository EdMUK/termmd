...
grid of cells, and draws that grid with a monospace font. Images transmitted
through the kitty protocol are decoded from the escape stream and composited at
the cell position termmd placed them. They are renderings of real output, not
